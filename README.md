[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32l23x-demo-suites-cmake-vscode)](https://github.com/burakenez/gd32l23x-demo-suites-cmake-vscode/tags/)

# GD32L23x Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32L23x Demo Suites CMake Visual Studio Code** repository! This project is designed to integrate the CMake build system with Visual Studio Code, providing a streamlined development environment for **_GD32L23x Demo Suites V2.4.0_**.
...
- **🧩 Lightweight Templates:** A structured and organized template for GD32L23x microcontroller projects.
...
### 2. **CMSIS/GD/GD32L23x**
- **Version:** `V2.2.0 (2025-02-10)`
- **Path:** `Drivers/CMSIS/GD/GD32L23x`
- Extracted from `GD32L23x Demo Suites V2.4.0`

### 3. **GD32L23x_standard_peripheral**
- **Version:** `V2.2.0 (2025-02-10)`
- **Path:** `Drivers/GD32L23x_standard_peripheral`

### 4. **GD32L23x_usbd_library**
- **Version:** `V2.2.0 (2025-02-10)`
- **Path:** `Drivers/GD32L23x_usbd_library`
...
git clone --recursive https://github.com/burakenez/gd32l23x-demo-suites-cmake-vscode.git
```
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32l23x_it.h  # Interrupt handler declarations specific to GD32L23x.
│           │   │   │   ├── gd32l23x_libopt.h  # Library options and configurations for efficient use.
│           │   │   │   └── systick.h  # Definitions and declarations related to the SysTick timer.
│           │   │   ├── Src
│           │   │   │   ├── gd32l23x_it.c  # Interrupt service routine implementations.
│           │   │   │   ├── main.c  # Entry point of the application, containing the main logic and system initialization.
│           │   │   │   ├── system_gd32l23x.c  # System initialization, clock setup, and core configurations.
│           │   │   │   └── systick.c  # SysTick timer setup and related functionalities.
│           │   ├── Startup
│           │   │   └── startup_gd32l23x.s  # Assembly code for initialization and vector table setup.
│           │   ├── User
...
│           ├── Drivers
│           │   ├── BSP/GD32L235R_EVAL  # Board support package configurations and drivers for GD32L235R_EVAL.
│           │   ├── CMSIS  # CMSIS drivers for Cortex-M processors, supporting GD32L23x.
│           │   └── GD32L23x_standard_peripheral  # Peripheral library for GD32L23x.
...
│           ├── gd32l23x_flash.ld  # Linker script for defining memory regions and placements.
│           └── GD32L23x.svd  # System View Description file for debugging and register definitions. 
